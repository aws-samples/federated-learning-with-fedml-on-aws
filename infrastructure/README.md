...
terraform apply -target=module.m_fedml_edge_client_1.module.vpc
terraform apply -target=module.m_fedml_edge_client_2
terraform apply -target=module.m_fedml_edge_server.module.vpc